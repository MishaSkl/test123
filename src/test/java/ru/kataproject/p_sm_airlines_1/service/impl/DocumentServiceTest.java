...
class DocumentServiceTest {
    ...
    void testGetDocumentById() {
        ...
        assertEquals(true, actualDocumentById.getIsDefault());
    ...
    void testGetDocumentById2() {
        ...
        when(document5.getIsDefault()).thenReturn(true);
        ...
        when(document5.setIsDefault(any())).thenReturn(document3);
        ...
        verify(document5).setIsDefault(any());
        verify(document5).getIsDefault();
    }

    /**
     * Method under test: {@link DocumentServiceImpl#createDocument(Document)}
     */
    @Test
    void testCreateDocument() {
        ...
        documentServiceImpl
                .createDocument(new Document(123L, DocumentType.NATIONAL_PASSPORT, "42",
                        LocalDate.ofEpochDay(1L), passenger, LocalDateTime.now(), LocalDateTime.now(),
                        true));
    ...
    /**
     * Method under test: {@link DocumentServiceImpl#updateDocument(Document)}
     */
    @Test
    void testUpdateDocument() {
        ...
        documentServiceImpl
                .updateDocument(new Document(123L, DocumentType.NATIONAL_PASSPORT, "42",
                        LocalDate.ofEpochDay(1L), passenger, LocalDateTime.now(), LocalDateTime.now(),
                        true));
        verify(documentRepository).saveAndFlush(any());
        verify(documentRepository).findById(any());
    ...
    void testUpdateDocument3() {
        ...
        when(document5.setNumber(any())).thenReturn(document2);
        when(document5.setPassenger(any())).thenReturn(document3);
        when(document5.setUpdatedAt(any())).thenReturn(document3);
        when(document5.setType(any())).thenReturn(document4);
        ...
        verify(document5, atLeast(1)).setIsDefault(any());
