...
public interface AircraftController {
    ...
    ResponseEntity<HttpStatus> createAircraft(@Valid @RequestBody AircraftDto aircraft);
    ...
    @ApiResponse(responseCode = "404", description = "Page not found")
    ResponseEntity<HttpStatus> updateAircraft(@Valid @RequestBody AircraftDto aircraftDto, @PathVariable Long id);
