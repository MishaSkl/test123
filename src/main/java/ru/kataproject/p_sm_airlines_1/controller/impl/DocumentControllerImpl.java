...
public class DocumentControllerImpl implements DocumentController {
    ...
    public void createDocument(DocumentDto documentDto) {
        ...
        documentService.createDocument(DocumentMapper.INSTANCE.mapToDocument(documentDto));
    }
    ...
    @Override
    @ResponseStatus(HttpStatus.OK)
    public void updateDocument(DocumentDto documentDto, Long id) {
        log.info("executed updateDocument() method");
        documentService.updateDocument(DocumentMapper.INSTANCE.mapToDocument(documentDto).setId(id));
    }
